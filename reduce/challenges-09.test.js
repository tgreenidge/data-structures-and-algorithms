...
const countNumberOfElements = (arr) => {
  return arr.reduce( (accumulator, val, ind) => {
...
const returnNames = (arr) => {
  return arr.reduce( (accumulator, obj, ind) => {
    accumulator[ind] = obj.name;
    return accumulator;
  }, []);
};
...
const reversedString = (arr) => {
  return arr.split('').reduce( (accumulator, str, ind) => {
...
const countNumberOfChildren = (arr) => {
  return arr.reduce( (accumulator, obj, ind) => {
    return obj.children ? accumulator + obj.children.length : accumulator;
  }, 0);
};
...
const calculateAverage = (arr) => {
  let acc = arr.reduce( (accumulator, val, ind) => {
    accumulator.count++;
    accumulator.sum += val;
    return accumulator;
  }, {count: 0, sum: 0});
...
const countPrimeNumbers = (arr) => {
  return arr.reduce( (accumulator, val, ind) => {
    return isPrime(val) ? accumulator + 1 : accumulator;
  }, 0);
};
